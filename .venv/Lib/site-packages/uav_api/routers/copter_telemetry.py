...
@copter_telemetry_router.get("/general", tags=["telemetry"], summary="Returns Copter general information such as velocities, heading, throttle percentage and altitude")
...
@copter_telemetry_router.get("/gps", tags=["telemetry"], summary="Returns the copter current GPS information (the information provided by this endpoint is generated by the fusion of multiple sensor data such as GPS and accelerometers)")
...
@copter_telemetry_router.get("/gps_raw", tags=["telemetry"], summary="Returns the copter current raw GPS information (the information provided by this endpoint is generated directly by the GPS sensor)")
...
@copter_telemetry_router.get("/ned", tags=["telemetry"], summary="Returns the copter current NED information (the information provided by this endpoint is generated by the fusion of multiple sensor data such as GPS and accelerometers)")
...
@copter_telemetry_router.get("/compass", tags=["telemetry"], summary="Returns compass calibration information")
def compass_info(uav: Copter = Depends(get_copter_instance), args: Namespace = Depends(get_args)):
    ...
    return res_obj
@copter_telemetry_router.get("/sys_status", tags=["telemetry"], summary="Returns raw SYS_STATUS message")
...
@copter_telemetry_router.get("/sensor_status", tags=["telemetry"], summary="Returns sensors status extraced from SYS_STATUS message")
...
@copter_telemetry_router.get("/battery_info", tags=["telemetry"], summary="Returns battery information extracted from SYS_STATUS message")
...
@copter_telemetry_router.get("/error_info", tags=["telemetry"], summary="Returns errors information extracted from SYS_STATUS message")
...
@copter_telemetry_router.get("/home_info", tags=["telemetry"], summary="Returns information about HOME position, which represents the point (0,0,0) in static NED coordinate frame")

...
class Copter:
    ...
    def mav_location(self, lat: float, long: float, alt: int):
    ...
    def get_ned_position(self, timeout=10):
        ...
        while True:
            ...
            if last_pos is None and msg is None:
                continue
            if msg is None:
                self.progress("Received local target: %s" % str(last_pos))
    ...
    def get_message(self, msg_type, timeout=10):
        ...
        while True:
            ...
            if last_msg is None and msg is None:
                continue
            if msg is None:
                self.progress("Message %s received: %s" % (msg_type, last_msg))
                return last_msg
            last_msg = msg
